const FinancialBanner = () => {
    return (
        <section className="flex flex-col lg:flex-row items-center justify-between px-12 bg-white rounded-lg">
            <div className="lg:w-1/2 space-y-6">
                <div>
                    <p className="text-gray-500">Navigating Your Financial Journey With</p>
