export default function FounderCard() {
    return (
        <div className="bg-white border-l border-gray-300  lg:mt-12 mt-10 lg:mx-18 mx-4 rounded-2xl flex flex-col md:flex-row items-center relative overflow-hidden    "
            style={{
        ...
        >
            ...
            <div className="z-10 cardWidths">
                <img
                    src="/Images/fcg2.png"
                    alt="Ramon Talwwar"
                    className="rounded-xl h-full py-2 transform"
            ...
            <div className="z-10 flex-1 cardWidths pl-25">
                ...
                <p className="text-[22px] leading-tight  font-medium text-gray-700 mt-2 text-center lg:text-start">
            ...
            <div className="z-10 w-full font-bold md:w-64 mt-6 lg:pb-0 pb-6 md:mt-0 border-l border-gray-300 pl-8 cardWidths">
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                    <li className="text-xs text-center mb-6 lg:text-start ">
